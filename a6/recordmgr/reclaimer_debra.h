...
//        if (!threadData[tid].init) {
//            setbench_error("Illegal use of record_manager by thread without first calling record_manager::initThread(tid)");
//        }
